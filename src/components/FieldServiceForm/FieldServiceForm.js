            ...
            <form className="">
              <div className="">
                <div className="service-menu my-3">
                  ...
                  <form
                    className={`service-fields m-2 ${fuelIsChecked === false ? "hidden" : ""
                      }`}
                  >
                    ...
                    <div className="form-row">
                      <div
                        className={` form-group col-md-6 ${fuelQty === "Gal" ? "" : "hidden"
                          }`}
                      >
                ...
                <div className="service-menu">
                  ...
                  <form
                    className={`service-fields ${oilIsChecked === false ? "hidden" : ""
                      }`}
                  >
                    <div className="form-row">
                      <div className="form-group col-md-6">
