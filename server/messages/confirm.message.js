...
const confirm = express()

const sgMail = require('@sendgrid/mail');
sgMail.setApiKey(process.env.SENDGRID_API_KEY);
confirm.post('/', (req, res) => {
  console.log('in email-confirm with my req.body', req.body);
  const {
    tail,
    first,
    last,
      ...
      >
        ...
        <div style="padding: auto; max-width: 1000px; width: auto; margin: auto">
          <div
            ...
            "
          >
            <h1 style="color: #0072ff">Thank you for your request, ${first}!</h1>
            <h3 style="color: #54595f">Placed ${appointment_date}</h3>
            ...
            >
              ...
              <table style="margin: auto; border-collapse: collapse; width: auto;">
                ...
                <tr>
                  ...
                  <td style=" border: 1px solid black; padding: 10px; width: auto;">${oil_qty}</td>
                </tr>
              </table>
            </div>
              ...
              <table style="margin: auto; border-collapse: collapse; width: auto; margin-bottom: 15px;">
                ...
                <tr>
                  ...
                  <th style=" border: 1px solid black; padding: 10px; width: auto; background-color: #939ba5;">SMS Preferred</th>
                </tr>
                <tr>
