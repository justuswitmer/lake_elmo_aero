      ...
      <div style="background-color: white; padding: 15px; margin-bottom: 30px;">
        <img style="max-width: 200px; width: auto; height: auto" src="${logo}" />
          ...
          >
           ...
           <p>We will reach out to you soon to let you know the status of your request</p>
            <div
              style="
            ...
            >
              ...
              <div style="margin: auto; margin-top: 1%; overflow-x: auto;">
                <table style="margin: auto; border-collapse: collapse; width: 500px">
                  <thead>
        ...
        <p style="color: black">3275 Manning Ave N Lake Elmo, Minnesota</p>
        <p style="color: black">© Lake Elmo Aero</p>
      </body>
    </html>
  `,
  };
